...
/*   Updated: 2025/01/30 17:44:25 by cmetee-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	swap_s(t_stack *a, t_stack *b, int print);
...
void	rotate_r(t_stack *a, t_stack *b, int print);
...
*/
void	rotate_rev_a(t_stack *a, int print);
void	rotate_rev_b(t_stack *b, int print);
void	rotate_rev_r(t_stack *a, t_stack *b, int print);
